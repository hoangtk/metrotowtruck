...
class product_product(osv.osv):
    ...
    def fields_view_get(self, cr, uid, view_id=None, view_type='form', context=None, toolbar=False, submenu=False):
        ...
        if view_type == 'form':
            ...
            model_id = self.pool.get('ir.model').search(cr, uid, [('model', '=', 'product.product')], context=context)
            attribute_group_ids = self.pool.get('attribute.group').search(cr, uid, [('model_id.model','=','product.product')], context=context)
